...
ALTER TABLE tb_itempedido ADD CONSTRAINT tb_itempedido_pk PRIMARY KEY ( id_item );
...
ALTER TABLE tb_bairro
    ADD CONSTRAINT fk_endereco_bairro FOREIGN KEY ( id_endereco )
        REFERENCES tb_endereco ( id_endereco );

ALTER TABLE tb_endereco
    ADD CONSTRAINT fk_endf_end FOREIGN KEY ( id_end_fornecedor )
        REFERENCES tb_endereco_fornecedor ( id_end_fornecedor );
...
ALTER TABLE tb_endereco_fornecedor
    ADD CONSTRAINT fk_fornecedor_endf FOREIGN KEY ( id_fornecedor )
...
ALTER TABLE tb_itempedido
    ADD CONSTRAINT fk_pedido_itemf FOREIGN KEY ( id_pedido )
        REFERENCES tb_pedido ( id_pedido );

ALTER TABLE tb_itemdecompra
    ADD CONSTRAINT fk_produto_itemc FOREIGN KEY ( id_produto )
...
ALTER TABLE tb_endereco
    ADD CONSTRAINT fk_usuario_end FOREIGN KEY ( id_usuario )
        REFERENCES tb_usuario ( id_usuario );

ALTER TABLE tb_itemdecompra
    ADD CONSTRAINT fk_usuario_itemc FOREIGN KEY ( id_usuario )
        REFERENCES tb_usuario ( id_usuario );

ALTER TABLE tb_itempedido
    ADD CONSTRAINT fk_usuario_itemf FOREIGN KEY ( id_usuario )
        REFERENCES tb_usuario ( id_usuario );
